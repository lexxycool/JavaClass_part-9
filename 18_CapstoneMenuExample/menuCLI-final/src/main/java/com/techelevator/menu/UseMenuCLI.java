...
public class UseMenuCLI { // Class representing the MenuCLI process to be used
    ...
    private final String MAIN_MENU_OPTION_1 = "List all instructional staff";
    private final String MAIN_MENU_OPTION_2 = "Option 2 Description";
    private final String MAIN_MENU_OPTION_3 = "Option 3 Description";
    private final String MAIN_MENU_OPTION_EXIT = "Exit";
    ...
    private final String[] MAIN_MENU_OPTIONS = {MAIN_MENU_OPTION_1, MAIN_MENU_OPTION_2, MAIN_MENU_OPTION_3,
            MAIN_MENU_OPTION_EXIT};

    private Menu menu;


    public UseMenuCLI(Menu menu) {  // constructor that takes in the menu object
        this.menu = menu;
    }
        ...
        while (shouldLoop) { // Loop while loop control variable is true
            ...
            switch (choice) {
                case MAIN_MENU_OPTION_1: {
                    ...
                    System.out.println("called menu option 1");
                    subMenu();
                    break;
                }
                case MAIN_MENU_OPTION_2: {
                    // process for option 1 choice - good place for a method call
                    System.out.println("called menu option 2");
                    break;
                }
                case MAIN_MENU_OPTION_3: {
                    // process for option 1 choice - good place for a method call
                    System.out.println("called menu option 3");
                    break;
                }
                case MAIN_MENU_OPTION_EXIT: {
                    // do any end of loop processing
                    System.out.println("ending the main loop and exiting the program");
                    shouldLoop = false;
                    break;
                }
            }
    ...
    public void subMenu(){
         ...
         * difficult.
         ********************************************************************************/
        final String[] INSTRUCTOR_OPTIONS = {"Andy", "Ben", "Joe", "Kevin", "Margaret", "Myron", "End Process"};
        ...
        while (shouldLoop) { // Loop while loop control variable is true
            ...
            switch (choice) {
                case "Andy": {
                    // process for option "Andy" choice - good place for a method call
                    System.out.println("Andy is awesome");
                    break;
                }
                case "Ben": {
                    // process for option "Ben" choice - good place for a method call
                    System.out.println("Ben is bright");
                    break;
                }
                case "Joe": {
                    // process for option "Joe" choice - good place for a method call
                    System.out.println("Joe is jaw-dropping");
                    break;
                }
                case "Kevin": {
                    // process for option "Josh" choice - good place for a method call
                    System.out.println("Kevin is quick");
                    break;
                }
                case "Margaret": {
                    // process for option "Dan" choice - good place for a method call
                    System.out.println("Margaret is OK");
                    break;
                }
                case "Myron": {
                    // process for option "Craig" choice - good place for a method call
                    System.out.println("Myron is magnificent");
                    break;
                }
                case "End Process": {
                    // do any end of loop processing
    ...
    public static void main(String[] args) {
        ...
        // Create object of this class in order to run the code
        UseMenuCLI cli = new UseMenuCLI(menu);
        cli.run();
    }
}
